...
$is_banner = qumodo_opt('archive_banner_toggle', 'show');
$is_breadcrumbs = qumodo_opt('archive_banner_breadcrumb', 'show');
$is_banner_title = qumodo_opt('is_archive_title', 'show');
$banner_url = qumodo_opt('archive_banner_img_upload');
