...
$show_banner = qumodo_opt('blog_banner_toggle', 'show')    ;
$banner_url = qumodo_opt('blog_banner_img_upload');
$show_title = qumodo_opt('is_blog_banner_title', 'show');
$title = qumodo_opt('blog_banner_title', get_bloginfo('name'));
